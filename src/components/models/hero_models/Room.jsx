...
export function Room(props) {
  const { nodes, materials } = useGLTF("/3d-portfolio/models/optimized-room.glb");
  const screensRef = useRef();
  const matcapTexture = useTexture("/3d-portfolio/images/textures/mat1.png");
...
useGLTF.preload("/3d-portfolio/models/optimized-room.glb");
